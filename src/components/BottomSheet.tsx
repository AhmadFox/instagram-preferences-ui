          ...
          >
            ...
            <div
              ...
              style={{
                ...
                overflowY: (currentSnap === 'full' && isContentScrollable && !isDragging) ? 'auto' : 'hidden',
                touchAction: (currentSnap === 'full' && isContentScrollable && !isDragging) ? 'pan-y' : 'none',
                cursor: (currentSnap === 'full' && isAtTop) ? 'grab' : 'auto'
              }}
              onPointerDown={(e) => {
                // If we're at the top of the content in full mode, allow dragging from anywhere
                if (currentSnap === 'full' && isAtTop) {
